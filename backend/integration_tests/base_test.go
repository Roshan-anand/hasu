...
func TestOrgOperations(t *testing.T) {
	...
	t.Run("Delete the only org", func(t *testing.T) {
		rec, err := TestEchoHandler(t, h.Org.DeleteOrg, orgReqBody, true, nil)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("Create a new org", func(t *testing.T) {
		rec, err := TestEchoHandler(t, h.Org.CreateOrg, createOrgBody, true, nil)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("get all orgs", func(t *testing.T) {
		rec, err := TestEchoHandler(t, h.Org.GetAllOrgs, nil, true, nil)
		if err != nil {
			t.Fatal(err)
		}
		body := rec.Result().Body
	...
	t.Run("switch org", func(t *testing.T) {
		...
		rec, err := TestEchoHandler(t, h.Org.SwitchOrg, orgReqBody, true, nil)
		if err != nil {
			t.Fatal(err)
		}
...
func TestProjectOperations(t *testing.T) {
	...
	t.Run("Create a new project", func(t *testing.T) {
		rec, err := TestEchoHandler(t, h.Project.CreateProject, createProjectBody, true, nil)
		if err != nil {
			t.Fatal(err)
		}
		body := rec.Result().Body
	...
	t.Run("get all project", func(t *testing.T) {
		...
		rec, err := TestEchoHandler(t, h.Project.GetAllProject, nil, true, query)
		if err != nil {
			t.Fatal(err)
		}
		body := rec.Result().Body
	...
	t.Run("delete the project", func(t *testing.T) {
		rec, err := TestEchoHandler(t, h.Project.DeleteProject, projectReqBody, true, nil)
		if err != nil {
			t.Fatal(err)
		}
